...
<template>
  <div ref="target" class="relative flex justify-center lg:col-span-4">
    <div class="absolute top-[5px] w-full">
      <div
        class="m-auto w-full max-w-[350px] rounded-lg border-2 border-gray-600 p-2 focus-within:border-2 focus-within:border-sky-400 focus-within:shadow-lg focus-within:shadow-black/40 focus-within:outline-none"
