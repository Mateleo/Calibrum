...
<template>
  <CommonInnerTitleSection title="Predictions (10 days)">
    ...
    <div
      ...
      class="border-b-2 border-gray-900 flex flex-nowrap justify-between px-3 py-2 items-center last:border-b-0 last:pb-0"
    >
      <div class="py-1">
        <NuxtLink
          :to="`/player/${account.player.name}`"
          class="font-semibold text-lg hover:text-cyan-400 transition-colors ease-in-out"
